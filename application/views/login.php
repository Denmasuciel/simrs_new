      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="mb-4">
              <h3>Log In to <strong>SIMRS</strong></h3>
              <p class="mb-4">Untuk dapat mengakses aplikasi SIMRS silahkan login.</p>
            </div>
            <form id="loginform" action="<?php echo base_url();?>login/validasi" method="post">
					<?php
