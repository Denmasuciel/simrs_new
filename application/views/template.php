                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span><?php echo $this->session->userdata('user_nm'); ?></span>
...
<![endif]-->
    ...
    <!-- <script type="text/javascript" src="<?php echo base_url(); ?>assets/files/assets/pages/dashboard/custom-dashboard.js"></script> -->
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/files/assets/js/script.min.js"></script>
