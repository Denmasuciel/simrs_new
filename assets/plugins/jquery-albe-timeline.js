	...
	$.fn.albeTimeline = function (json, options) {
		...
		var idioma = ($.fn.albeTimeline.languages.hasOwnProperty(settings.language)) ?
			$.fn.albeTimeline.languages[settings.language] : { // pt-BR
				...
				months: ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Dezember'],
				shortMonths: ['Jan', 'Feb', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'Sep', 'Okt', 'Nov', 'Des'],
				separator: 'de',
				msgEmptyContent: 'Tidak ada data yang ditampilkan.',
			};
		...
		// var eMenu = $('<ul>').attr('id', 'timeline timeline-inverse');
